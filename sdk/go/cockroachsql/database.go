...
func NewDatabase(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("cockroachsql:index/database:Database", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabase(ctx *pulumi.Context,
	...
	var resource Database
	err := ctx.ReadResource("cockroachsql:index/database:Database", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
