...
def get_schemas(database: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cockroachsql:index/getSchemas:getSchemas', __args__, opts=opts, typ=GetSchemasResult).value
...
def get_schemas_output(database: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cockroachsql:index/getSchemas:getSchemas', __args__, opts=opts, typ=GetSchemasResult)
