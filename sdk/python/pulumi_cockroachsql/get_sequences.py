...
def get_sequences(database: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cockroachsql:index/getSequences:getSequences', __args__, opts=opts, typ=GetSequencesResult).value
...
def get_sequences_output(database: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cockroachsql:index/getSequences:getSequences', __args__, opts=opts, typ=GetSequencesResult)
