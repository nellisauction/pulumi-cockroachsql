...
{
    [CockroachSqlResourceType("cockroachsql:index/defaultPrivileges:DefaultPrivileges")]
    public partial class DefaultPrivileges : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("forAllRoles")]
        public Output<bool?> ForAllRoles { get; private set; } = null!;
        ...
        public DefaultPrivileges(string name, DefaultPrivilegesArgs args, CustomResourceOptions? options = null)
            : base("cockroachsql:index/defaultPrivileges:DefaultPrivileges", name, args ?? new DefaultPrivilegesArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private DefaultPrivileges(string name, Input<string> id, DefaultPrivilegesState? state = null, CustomResourceOptions? options = null)
            : base("cockroachsql:index/defaultPrivileges:DefaultPrivileges", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DefaultPrivilegesArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("forAllRoles")]
        public Input<bool>? ForAllRoles { get; set; }
