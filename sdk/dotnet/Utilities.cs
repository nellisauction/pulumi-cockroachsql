...
namespace Pulumi.CockroachSql
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/nellisauction/pulumi-cockroachsql";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.CockroachSql.version.txt");
    ...
    internal sealed class CockroachSqlResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public CockroachSqlResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
