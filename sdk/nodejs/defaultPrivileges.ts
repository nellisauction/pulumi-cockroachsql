...
export class DefaultPrivileges extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cockroachsql:index/defaultPrivileges:DefaultPrivileges';
     ...
     */
    declare public readonly forAllRoles: pulumi.Output<boolean | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: DefaultPrivilegesArgs | DefaultPrivilegesState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["forAllRoles"] = state?.forAllRoles;
            ...
            resourceInputs["forAllRoles"] = args?.forAllRoles;
...
export interface DefaultPrivilegesState {
     ...
     * If true, alter default privileges for all roles.
     */
    forAllRoles?: pulumi.Input<boolean | undefined>;
    /**
     * The CockroachSQL object type to set the default privileges on (one of: table, sequence, function, routine, type, schema)
     */
