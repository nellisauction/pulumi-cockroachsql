...
export function getSequences(args: GetSequencesArgs, opts?: pulumi.InvokeOptions): Promise<GetSequencesResult> {
    ...
    return pulumi.runtime.invoke("cockroachsql:index/getSequences:getSequences", {
...
export function getSequencesOutput(args: GetSequencesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSequencesResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("cockroachsql:index/getSequences:getSequences", {
        "database": args.database,
        "likeAllPatterns": args.likeAllPatterns,
        "likeAnyPatterns": args.likeAnyPatterns,
        "notLikeAllPatterns": args.notLikeAllPatterns,
